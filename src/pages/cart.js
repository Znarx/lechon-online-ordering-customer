...
export default function Cart() {
  ...
  const handleDelete = (priceid, productType) => {
    removeFromCart(priceid, productType);
  };
      ...
      />
                        <div>
                          ...
                          <div className="flex items-center space-x-2">
                            <button
                              onClick={() => updateQuantity(item.priceid, item.quantity - 1, item.productType)}
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <button 
                          ...
                          onClick={() => handleDelete(item.priceid, item.productType)}
                        >
